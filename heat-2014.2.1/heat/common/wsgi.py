...
gcloud_template_api_opts = [
    cfg.StrOpt('bind_host', default='0.0.0.0',
               help=_('Address to bind the server. Useful when '
                      'selecting a particular network interface.'),
               deprecated_group='DEFAULT'),
    cfg.IntOpt('bind_port', default=8999,
...
gcloud_template_api_group = cfg.OptGroup('gcloud_template_api')
cfg.CONF.register_group(gcloud_template_api_group)
cfg.CONF.register_opts(gcloud_template_api_opts,
                       group=gcloud_template_api_group)
