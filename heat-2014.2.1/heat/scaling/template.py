...
def resource_templates_by_name(old_resources, resource_definition, definition_name):
    for (name, definition) in old_resources:
        if name == definition_name:
            print "resource %s is change  definition"  %definition_name
            yield name, resource_definition
        else:
