...
class AutoScalingPolicy(signal_responder.SignalResponder,
    ...
    **Note** while it may incidentally support
    ...
    EXACT_CAPACITY, CHANGE_IN_CAPACITY, PERCENT_CHANGE_IN_CAPACITY, SCALE_OUT_FIRST, \
        SCALE_UP_FIRST, SCALE_OUT, SCALE_UP = (
        'exact_capacity', 'change_in_capacity', 'percent_change_in_capacity', 'scaleOutFirst',
        'scaleUpFirst', 'scaleOut', 'scaleUp')
    ...
    def _get_adjustement_type(self):
        ...
        return ''.join([t for t in adjustment_type.split('_')])
