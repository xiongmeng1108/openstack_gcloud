...
class EngineClient(object):
    ...
    def create_stack(self, ctxt, stack_name, template, params, files, args, task_id=None):
        """
        ...
        :param files: files referenced from the environment.
        :param args: Request parameters/args passed from API
        :param task_id: id of  task  add by zhangyk
        """
    ...
    def delete_stack(self, ctxt, stack_identity, cast=True, task_id=None):
        """
        ...
        return rpc_method(ctxt,
                          self.make_msg('delete_stack',
                                        stack_identity=stack_identity, task_id=task_id))
    ...
    def stack_suspend(self, ctxt, stack_identity, task_id=None):
        return self.call(ctxt, self.make_msg('stack_suspend',
                                             stack_identity=stack_identity,
                                             task_id=task_id))

    def stack_resume(self, ctxt, stack_identity, task_id=None):
...
class GcloudClient(object):
    ...
    def report_stack_task(self, cnxt, stack):
        ...
        self._client.cast(cnxt, "report_task", **kwargs)
