...
class RpcCallbacks(n_rpc.RpcCallback,
    ...
    def get_device_details(self, rpc_context, **kwargs):
        ...
        #brk(host="10.10.12.21", port=49161)
    ...
    def get_qos_details(self,rpc_context, **kwargs):
        ...
        plugin = manager.NeutronManager.get_plugin()
        port_id = plugin._device_to_port_id(device)
        gcloudqos_plugin = manager.NeutronManager.get_service_plugins().get(
            service_constants.QOS)
        if ( port_id and gcloudqos_plugin):
             port_qos=gcloudqos_plugin.get_qos(rpc_context,id=port_id)
             return port_qos
...
class AgentNotifierApi(n_rpc.RpcProxy,
    ...
    def qos_update(self,context,qos):
        self.fanout_cast(context,
