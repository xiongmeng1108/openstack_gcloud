...
class LbaasAgentManager(n_rpc.RpcCallback, periodic_task.PeriodicTasks):
    ...
    def create_vip(self, context, vip):
        ...
        try:
            #/usr/lib/python2.7/site-packages/neutron/services/loadbalancer/drivers/haproxy/namespace_driver.py(318)create_vip()
    ...
    def create_pool(self, context, pool, driver_name):
        ...
        driver = self.device_drivers[driver_name]   # # 获取相应的driver（根据设置默认为HaproxyNSDriver）
        try:
            #/usr/lib/python2.7/site-packages/neutron/services/loadbalancer/drivers/haproxy/namespace_driver.py(326)create_pool()
            ...
            self.plugin_rpc.update_status('pool', pool['id'], constants.ACTIVE)  ## 之后更新数据库中的状态
