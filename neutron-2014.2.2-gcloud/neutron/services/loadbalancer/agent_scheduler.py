...
class ChanceScheduler(object):
    ...
    def schedule(self, plugin, context, pool, device_driver):
        ...
        with context.session.begin(subtransactions=True):
            ...
            active_agents = plugin.get_lbaas_agents(context, active=True) #从数据库agents表中查询类型为Loadbalancer agent,admin_state_up状态为Active的lbaas-agent
            ...
            binding = PoolLoadbalancerAgentBinding()   #与pool进行绑定
