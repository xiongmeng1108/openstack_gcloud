...
class SecurityGroupInvalidPortRange(qexception.InvalidInput):
    message = _("For TCP/UDP protocols, port_range_min must be "
                "<= port_range_max")
    code =  "neutron_server_securitygroup_000001"

class SecurityGroupInvalidPortValue(qexception.InvalidInput):
    message = _("Invalid value for port %(port)s")
    code =  "neutron_server_securitygroup_000002"
...
class SecurityGroupInvalidIcmpValue(qexception.InvalidInput):
    ...
    code =  "neutron_server_securitygroup_000003"
...
class SecurityGroupRuleInvalidProtocol(qexception.InvalidInput):
    ...
    code =  "neutron_server_securitygroup_000009"
...
class SecurityGroupRemoteGroupAndRemoteIpPrefix(qexception.InvalidInput):
    message = _("Only remote_ip_prefix or remote_group_id may "
                "be provided.")
    code =  "neutron_server_securitygroup_000010"
...
class SecurityGroupProtocolRequiredWithPorts(qexception.InvalidInput):
    ...
    code =  "neutron_server_securitygroup_000011"
...
class SecurityGroupRuleParameterConflict(qexception.InvalidInput):
    ...
    code =  "neutron_server_securitygroup_000017"

class SecurityGroupNotSpecified(qexception.InvalidInput):
    message = _("no security group assign, please specified one!")
    code =  "neutron_server_securitygroup_000018"
...
#alter by xm for bug 6049 at 2015.8.31----begin---
# #sg_supported_ethertypes = ['IPv4', 'IPv6']
sg_supported_ethertypes = ['IPv4']
#alter by xm for bug 6049 at 2015.8.31----end---
...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    'securitygroupportbings':#add by luoyibing test
        { 'security_id': {'allow_post': False, 'allow_put': False,
               'validate': {'type:uuid': None},
               'is_visible': True,
               'primary_key': True},
          }
...
class Securitygroup(extensions.ExtensionDescriptor):
    ...
    def get_resources(cls):
        ...
        for resource_name in ['security_group', 'security_group_rule','securitygroupportbing']:
