...
class MemberExists(qexception.NeutronException):
    ...
    code="neutron_server_lbaas_000015"

class VipAssociateFloatingipExists(qexception.NeutronException):
    message = _("Vip with port %(port_id)s has been associated with floating ip %(floating_ip)s")
    code = "neutron_server_lbaas_000016"
...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    'pools': {
        ...
        'subnet_id': {'allow_post': True, 'allow_put': False,
                      'validate': {'type:uuid': None},
                      'is_visible': True},
        #add by xm-2015.5.26-create_time,user_id
        ...
        'cidr': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
        'vip_address': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
        'vip_name': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
        'port_id': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
        'protocol': {'allow_post': True, 'allow_put': False,
    ...
    'members': {
        ...
        'status_description': {'allow_post': False, 'allow_put': False,
                               'is_visible': True},
        #add by xm-2015.5.27-create_time,user_id,port_id,instance_id
        'create_time': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
        'user_id': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
        #add by xm-2015.6.11-add 'default':''  当allow_post/allow_put为True时，需要指定default默认值才能保证api接口可选（不传该参数）
    ...
    'health_monitors': {
        ...
        'status_description': {'allow_post': False, 'allow_put': False,
                               'is_visible': True},
        #add by xm-2015.7.14-create_time,user_id
        'create_time': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
        'user_id': {'allow_post': False, 'allow_put': False,
                      'is_visible': True},
