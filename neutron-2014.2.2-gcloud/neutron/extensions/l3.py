...
RESOURCE_ATTRIBUTE_MAP = {
    ...
    'floatingips': {
        ...
        'router_qosrule': {'allow_post': False, 'allow_put': False,
                                 'is_visible': True},  # add by xm 20160303
        'type': {'allow_post': True, 'allow_put': False, 'is_visible': True,
                 'default': None,
...
class L3(extensions.ExtensionDescriptor):
    ...
    def get_resources(cls):
        ...
        action_map = {'router': {'add_router_interface': 'PUT',
                                 ...
                                 'create_router_gatewayip':'PUT',
                                 'get_router_gatewayip':'GET'
                                   }}
