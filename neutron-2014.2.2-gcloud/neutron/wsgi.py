...
class ActionDispatcher(object):
    ...
    def dispatch(self, *args, **kwargs):
        ...
        return action_method(*args, **kwargs)  #/usr/lib/python2.7/site-packages/neutron/wsgi.py(615)default()
...
class TextDeserializer(ActionDispatcher):
    ...
    def deserialize(self, datastring, action='default'):
        return self.dispatch(datastring, action=action)  #/usr/lib/python2.7/site-packages/neutron/wsgi.py(368)dispatch()
...
class JSONDeserializer(TextDeserializer):
    ...
    def _from_json(self, datastring):
        try:
            return jsonutils.loads(datastring) #/usr/lib/python2.7/site-packages/neutron/openstack/common/jsonutils.py(171)loads()
        except ValueError:
            msg = _("Cannot understand JSON")
            raise exception.MalformedRequestBody(reason=msg)

    def default(self, datastring):
        return {'body': self._from_json(datastring)}   #datastring= '{"subnet": {"gateway_ip": null, "name": "111111-test22"}}'
