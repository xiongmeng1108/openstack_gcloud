...
class AgentDbMixin(ext_agent.AgentPluginBase):
    ...
    #direct called by neutron-server  #neutron/db/common_db_mixin.py/def _get_collection_count
    def get_agents(self, context, filters=None, fields=None):
        return self._get_collection(context, Agent,
                                    self._make_agent_dict,
                                    filters=filters, fields=fields)

    # #neutron/db/common_db_mixin.py/def _get_collection_count
    # def get_agents_count(self, context, filters=None):
    #     return self._get_collection_count(context, Agent,
    #                                       filters=filters)
