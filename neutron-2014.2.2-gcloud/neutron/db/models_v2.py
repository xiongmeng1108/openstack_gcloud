...
class HasCreateTime(object):
    ...
    create_time = sa.Column(sa.String(26),default=timeutils.strtime2)

    #create_time = sa.Column(sa.String(26),default=uuidutils.generate_uuid)
...
class Port(model_base.BASEV2, HasId,HasCreateTime,HasTenant):
    ...
    user_id = sa.Column(sa.String(64),  nullable=True)
    used_status = sa.Column(sa.String(10),  nullable=True)


    def __init__(self, id=None, tenant_id=None, name=None, network_id=None,
                 mac_address=None, admin_state_up=None, status=None,
                 device_id=None, device_owner=None, fixed_ips=None,user_id=None,used_status=None):
        self.id = id
...
class Subnet(model_base.BASEV2, HasId,HasCreateTime,HasTenant):
...
class Network(model_base.BASEV2, HasId,HasCreateTime, HasTenant):
