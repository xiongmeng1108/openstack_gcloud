...
class L3_NAT_with_dvr_db_mixin(l3_db.L3_NAT_db_mixin,
    ...
    def remove_router_interface(self, context, router_id, interface_info):
        if not interface_info:
            ...
            raise n_exc.BadRequest(resource='router', msg=msg, gcloud_code='neutron_server_l3route_000011')
    ...
    #只有列表类接口才支持filters过滤查询，此接口不支持(即filters接收不了api传送过来的过滤条件)
    def get_router_interface(self, context, router_id, filters=None):
        #brk(host="10.10.0.90", port=50196)
        ...
        router = {"router_id": router_id, "ports": ports}
        return router
    ...
    def get_sync_data(self, context, router_ids=None, active=None):
        #LOG.debug(_("111111 l3_dvr_db.py line 393"))
        ...
        #LOG.debug(_("111111 l3_dvr_db.py line 393 routers_dict=%s"), routers_dict)
        self._process_floating_ips(context, routers_dict, floating_ips)
        self._process_interfaces(routers_dict, interfaces)
        #self._process_floating_ip_qoss(routers_dict,floating_ip_qoss) delete by 2016/3/9
    ...
    def create_fip_agent_gw_port_if_not_exists(
        ...
        if l3_agent_db:
            ...
            if not f_port:
                ...
                raise n_exc.BadRequest(resource='router', msg=msg, gcloud_code='neutron_server_l3route_000012')
            else:
    ...
    def add_csnat_router_interface_port(
        ...
        if not snat_port:
            ...
            raise n_exc.BadRequest(resource='router', msg=msg, gcloud_code='neutron_server_l3route_000013')
