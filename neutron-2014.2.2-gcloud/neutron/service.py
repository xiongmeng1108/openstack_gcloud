...
service_opts = [
    ...
    cfg.IntOpt('api_workers',
               default=0,
               help=_('Number of separate API worker processes for service, default is the num of cores')),
...
def _run_wsgi(app_name):
    ...
    api_workers = cfg.CONF.api_workers or get_worker_count()
...
class Service(n_rpc.Service):
    ...
    def start(self):
        ...
        #start方法创建RPC消费者，利用oslo.message组件启动l3_agent服务,开始监听
