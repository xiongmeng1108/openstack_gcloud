...
RESOURCE_ATTRIBUTE_MAP = {
    NETWORKS: {
        ...
        'subnets_num': {'allow_post': False, 'allow_put': False,
                   'is_visible': True},
        #'user_name': {'allow_post': False, 'allow_put': False,
        #           'is_visible': True},
        # add by xm-2015.5.18-create_time,user_id
    ...
    PORTS: {
        ...
        'user_id':{'allow_post': False, 'allow_put': False,
                   'is_visible': True},
        'used_status': {'allow_post': True, 'allow_put': True,'default': '',
                 'validate': {'type:string': None},
                 'is_visible': True},
    },
    SUBNETS: {
        ...
        'type': {'allow_post': True, 'allow_put': True,
                          'default': None,
                          'validate': {'type:values':
                                         constants.EXT_NET_TYPE},
                          'is_visible': True},
    }
}


   #   'type': {'allow_post': True, 'allow_put': False, 'default': '',
   #              'is_visible': True, 'validate': {'type:string': None}},
