...
class ExtensionManager(object):
    ...
    def extend_resources(self, version, attr_map):
        ...
        for ext in update_exts:
            ext.update_attributes_map(attr_map)   #/usr/lib/python2.7/site-packages/neutron/api/extensions.py(157)update_attributes_map()
    ...
    def _load_all_extensions_from_path(self, path):
        ...
        # Neutron Servers
        #path = /usr/lib/python2.7/site-packages/neutron/extensions
        for f in sorted(os.listdir(path)):
            try:
                ...
                if file_ext.lower() == '.py' and not mod_name.startswith('_'):
                    mod = imp.load_source(mod_name, ext_path)     # mod = <module 'agent' from '/usr/lib/python2.7/site-packages/neutron/extensions/agent.pyc'>
                    ext_name = mod_name[0].upper() + mod_name[1:]  # ext_name=Agent
                    new_ext_class = getattr(mod, ext_name, None)  # new_ext_class=<class 'agent.Agent'>
                    if not new_ext_class:
                        LOG.warn(_('Did not find expected name '
                                 ...
                                 {'ext_name': ext_name,
                                  'file': ext_path})
                        continue
                    new_ext = new_ext_class()  # new_ext=<agent.Agent object at 0x3d84a10>
    ...
    def add_extension(self, ext):
        ...
        if not self._check_extension(ext):    #class PluginAwareExtensionManager line 587
            return
...
class PluginAwareExtensionManager(ExtensionManager):
    ...
    def get_instance(cls):
        if cls._instance is None:
            ...
            #get_extensions_path()=/usr/lib/python2.7/site-packages/neutron/extensions
            #manager.NeutronManager.get_service_plugins()={'CORE': <weakproxy at 0x39f70a8 to Ml2Plugin at 0x2889690>, 'qos': <weakproxy at 0x3d77db8 to QosPluginV2 at 0x39f4ad0>, 'ipinfo': <weakproxy at 0x3d77e10 to IpInfoPluginV2 at 0x3d51590>, 'FIREWALL': <weakproxy at 0x3d77e68 to FirewallPlugin at 0x33bb310>, 'METERING': <weakproxy at 0x3d77ec0 to MeteringPlugin at 0x39ec110>, 'phynetwork': <weakproxy at 0x3d77f18 to PhyNetworkPlugin at 0x3d78a50>, 'L3_ROUTER_NAT': <weakproxy at 0x3d77f70 to L3RouterPlugin at 0x33bb450>, 'VPN': <weakproxy at 0x3d77fc8 to VPNDriverPlugin at 0x37b7b10>, 'LOADBALANCER': <weakproxy at 0x3d87050 to LoadBalancerPlugin at 0x34c5f50>}
