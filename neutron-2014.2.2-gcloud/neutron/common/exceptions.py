...
class BadRequest(NeutronException):
    def __init__(self, **kwargs):
        try:
                is_default=True #load default code
                if kwargs != None :
                        if  kwargs.get("gcloud_code",None) != None:
                            self.code= kwargs.pop("gcloud_code",'neutron_server_common_000001')
                            is_default=False #not load default code

                if is_default:
                        if hasattr(self,"code") is False:
                               self.code='neutron_server_common_000001'
    ...
    #code="neutron_server_common_000001"
...
class NotAuthorized(NeutronException):
    ...
    code="neutron_server_common_000002"

class ServiceUnavailable(NeutronException):
    message = _("The service is unavailable")
    code="neutron_server_common_000003"

class AdminRequired(NotAuthorized):
    message = _("User does not have admin privileges: %(reason)s")
    code="neutron_server_common_000004"

class PolicyNotAuthorized(NotAuthorized):
    message = _("Policy doesn't allow %(action)s to be performed.")
    code="neutron_server_common_000005"

class NetworkNotFound(NotFound):
    message = _("Network %(net_id)s could not be found")
    code="neutron_server_network_000001"

class SubnetNotFound(NotFound):
    message = _("Subnet %(subnet_id)s could not be found")
    code="neutron_server_subnet_000001"

class PortNotFound(NotFound):
    message = _("Port %(port_id)s could not be found")
    code="neutron_server_port_000001"
...
class PolicyFileNotFound(NotFound):
    ...
    code="neutron_server_common_000006"
...
class InvalidSharedSetting(Conflict):
    ...
    code="neutron_server_network_000012"
...
class NetworkVlanRangeError(NeutronException):
    ...
    code="neutron_server_network_000015"
...
class InvalidCIDR(BadRequest):
    ...
    code="neutron_server_subnet_000006"




class SubNetIsExistRoute(NeutronException):
    ...
    """
    message = _("Router already has a port on subnet %(subnet)s")
    code="neutron_server_l3route_000001"
